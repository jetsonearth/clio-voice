                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(spacing: 0) {
                            ...
                            VStack(spacing: 60) {
                                ...
                                // Title and subtitle
                                VStack(spacing: 16) {
                                    Text(localizationManager.localizedString("onboarding.main.title"))
                                        .font(.system(size: min(geometry.size.width * 0.055, 42), weight: .bold))
                                        .foregroundColor(DarkTheme.textPrimary)
                                        .opacity(textOpacity)
                                        .multilineTextAlignment(.center)
                                        .padding(.horizontal)
                                    
                                    Text(localizationManager.localizedString("onboarding.main.subtitle"))
                                        .font(.system(size: min(geometry.size.width * 0.032, 24), weight: .medium))
                            ...
                            if showSecondaryElements {
                                VStack(spacing: 20) {
                                    Button(action: {
                                        ...
                                        Text(localizationManager.localizedString("onboarding.button.get_started"))
                                    ...
                                    SkipButton(text: localizationManager.localizedString("onboarding.button.skip_tour")) {
...
struct TypewriterRoles: View {
    ...
    private var roles: [String] {
        [
            localizationManager.localizedString("onboarding.typewriter.role_1"),
            localizationManager.localizedString("onboarding.typewriter.role_2"),
            localizationManager.localizedString("onboarding.typewriter.role_3"),
            localizationManager.localizedString("onboarding.typewriter.role_4")
        ]
    }
                    ...
                    .foregroundStyle(
                        LinearGradient(
                            colors: [
                                ...
                                DarkTheme.textPrimary.opacity(0.9)
                            ],
